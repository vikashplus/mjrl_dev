...
pol_dir=$2     # directories to search for policies
...
do
    ...
    output_dir=$pol_dir/../dataset/$env_name/seed$seed/
    mkdir -p $output_dir
    ...
    sim_backend=MUJOCO python /Users/vikashplus/Libraries/mj_envs/robohive/utils/examine_env.py \
        --env_name $env_name \
        --policy_path $policy \
